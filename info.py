...
USERNAME = environ.get('USERNAME', "https://telegram.me/Anand_2K")
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002632208091'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002632208091'))
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002144697861')
